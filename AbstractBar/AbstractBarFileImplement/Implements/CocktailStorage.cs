...
namespace AbstractBarFileImplement.Implements
{
    public class CocktailStorage : ICocktailStorage
    {
        ...
        public CocktailViewModel GetElement(CocktailBindingModel model)
        {
            ...
            var cocktail = source.Cocktails.FirstOrDefault(rec => rec.CocktailName == model.CocktailName || rec.Id == model.Id);
        ...
        {
            var element = source.Cocktails.FirstOrDefault(rec => rec.Id == model.Id);
            if (element == null)
            {
        ...
        {
            Cocktail element = source.Cocktails.FirstOrDefault(rec => rec.Id == model.Id);
            if (element != null)
            {
