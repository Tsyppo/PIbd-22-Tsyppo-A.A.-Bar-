...
using AbstractBarClientApp.Models;
...
namespace AbstractBarClientApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public void Create(int cocktail, int count, decimal sum)
        {
            if (count == 0 || sum == 0)
            {
                return;
        ...
        [HttpPost]
        public decimal Calc(decimal count, int cocktail)
        {
